namespace :accounts do
  desc <<-EOS
    Create an administrative user and/or set the password for said user. This
    task accepts two arguments, the username and optionally a password. If the
    password is not supplied, the username will be used for the password.
  EOS
